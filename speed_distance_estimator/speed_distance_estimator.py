        ...
        for object,object_tracks in tracks.items():
            ...
            for frame_num in range(0,number_of_frames,self.frame_window):
                ...
                for track_id,_ in object_tracks[frame_num].items():
                    ...
                    speed_KPH = speed_meters_per_sec * 3.6
            ...
            for object, object_tracks in tracks.items():
                ...
                for _,track_info in object_tracks[frame_num].items():
                    if 'speed' in track_info:
                        ...
                        cv.putText(frame,f"{speed: .2f} km/h",position,cv.FONT_HERSHEY_SIMPLEX,0.5,(0,0,0),int(2))
                        cv.putText(frame,f"{distance: .2f} km/h",(position[0],position[1]+20),cv.FONT_HERSHEY_SIMPLEX,0.5,(0,0,0),int(2))
